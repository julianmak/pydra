...
do iz=1,nz
  do ix=0,nxm1
    do iy=0,ny
      qq(iy,ix,iz)=wka(iy,ix,iz)+qc(iy,ix,iz)
    enddo
  enddo
enddo
...
do iz=1,nz
  ...
  do ix=0,nxm1
    do iy=0,ny
      qq(iy,ix,iz)=qq(iy,ix,iz)+qqadd+qd(iy,ix,iz)
    enddo
  enddo
enddo
...
do iz=1,nz
  do ix=0,nxm1
    do iy=0,ny
      qs(iy,ix,iz)=wka(iy,ix,iz)+qc(iy,ix,iz)
    enddo
  enddo
enddo

 !------------------------------------------------------------
 !Reset qd = q-qc-F[q-qc] and restore domain average:
do iz=1,nz
  call average(qs(0,0,iz),qavg0)
  qsadd=qavg(iz)-qavg0
  do ix=0,nxm1
    do iy=0,ny
      qs(iy,ix,iz)=qs(iy,ix,iz)+qsadd+qd(iy,ix,iz)
